  ...
  <div class="container">
    ...
    <tbody>
      <?php
        ...
        <td><img class="img-responsive" style="height: 50px;" src="image/<?php echo $result['image'] ?>"></td>
        <td><a href="donor_pdf.php?action=pdf&id=<?php echo $result['id']; ?>">Get PDF</a></td>
        <td><a href="donor_delete.php?action=delete&id=<?php echo $result['id']; ?>" class="btn btn-outline-danger btn-sm">Delete</a></td>
        <?php
      }
